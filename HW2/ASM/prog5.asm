...
; This program creates threads with F1 and F3, waits until they are done to let them run in parallel then ends the program. The difference between this program and second program is, F1 and F3 yields the CPU on every iteration to let others run
...
fn1_loop:
	...
	CALL GTU_OS		; System call for upper instruction
	MVI a, TYield		; Yield the CPU to let others use it after printing
	CALL GTU_OS		; System call for upper instruction
